<?php
/*
Website:  http://www.dev4ever.net/
Contact:  support@dev4ever.net
Date:     12/02/2014        
*/
...
<title>Welcome - PHP Plugins System Solution</title>
...
<div id="dcpage">
<div id="header">
	<a href="install.php"> <h1>SMARTY LEOPARD - Plugin system solution</h1></a>
</div>
<br /><br />
...
<?php 
	...
	if (empty($_GET["step"])) {
	    echo "<div class='section_box'>Welcome to the installation of SMARTY LEOPARD.<br />
